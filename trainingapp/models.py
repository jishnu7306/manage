...
class user_registration(models.Model):
    ...
    category=models.ForeignKey(category, on_delete=models.SET_NULL,related_name='catgname', null=True, blank=True)
...
class trainer_task(models.Model):
    ...
    trainer_task_submitteddate = models.DateField(auto_now_add=False, auto_now=False,  null=True, blank=True)
